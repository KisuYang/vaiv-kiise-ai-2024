...
if __name__ == "__main__":
  ...
  parser.add_argument("--adapter_name", required=True)
  parser.add_argument("--dataset_name", default="vaiv/ko-rag-preference")
  parser.add_argument("--dataset_split", default="validation")
  parser.add_argument("--chatgpt_model", default="gpt-4")
